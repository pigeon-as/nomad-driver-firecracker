...
- See [AGENTS.md](../AGENTS.md) for the full cross-check list.
...
Flag any deviation in framework code. Domain-specific behavior (vsock signals, Ctrl+Alt+Del, snapshot, jailer) is expected and does not need justification.
